...
const mainSrc = fs.readFileSync(path.join(rootDir, 'src/main.ts'), 'utf8');
assert(
  menuSrc.includes("'view:icon-theme'") || mainSrc.includes("'view:icon-theme'"),
  'View > Appearance contains the Icon Theme chooser (FR-Q1a → v0.2 FR-M9)'
);
