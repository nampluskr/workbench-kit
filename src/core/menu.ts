...
export const DEFAULT_FILE_ITEMS: readonly MenuItem[] = Object.freeze([
  ...
  // Plain checkbox row, not a submenu — a single safety gate for Explorer
  // delete. Moved here from View (v0.3, user request 2026-09-25), between
  // the Close group and Exit, per a follow-up user request the same day.
  Object.freeze({ id: 'file:delete-enabled', label: 'Allow Delete in Explorer' }),
  separator('file:separator-delete'),
